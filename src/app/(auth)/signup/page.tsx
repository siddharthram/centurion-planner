...
export default function SignupPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden">
      ...
      {/* Floating orb */}
      <div className="absolute -bottom-40 -left-40 h-80 w-80 rounded-full bg-gradient-to-br from-orange-200 to-amber-300 opacity-30 blur-3xl dark:from-orange-900 dark:to-amber-900 dark:opacity-20" />
      ...
      <div className="relative z-10 w-full max-w-md space-y-8 px-4">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Create your Centurion Planner account
          </p>
        </div>
